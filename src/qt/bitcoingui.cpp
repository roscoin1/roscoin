...
extern unsigned int nTargetSpacingNew;
...
void BitcoinGUI::createActions()
{
    ...
    blockAction = new QAction(QIcon(":/icons/bex"), tr("&Block Explorer"), this);
          ...
          statisticsAction = new QAction(QIcon(":/icons/node"), tr("&Nodes Control"), this);
                  ...
                  tabGroup->addAction(statisticsAction);
                           ...
                           sendCoinsAction2->setToolTip(tr("Send coins to a Roscoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Roscoin"), this);
    ...
    optionsAction2->setToolTip(tr("Modify configuration options for Roscoin"));
...
void BitcoinGUI::updateStakingIcon()
{
    ...
    if (nLastCoinStakeSearchInterval && nWeight)
    {
		...
		if (pindexBest->nHeight >= 75000) {
			unsigned nEstimateTime = nTargetSpacingNew * nNetworkWeight / nWeight;
		}
